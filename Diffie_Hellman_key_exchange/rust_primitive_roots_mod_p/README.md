...
Modular exponentiation with large numbers can get out of hand quickly if the base is raised to some large x. One solution for this is the recursive method "**exponentiation by squaring**" which I use here.
